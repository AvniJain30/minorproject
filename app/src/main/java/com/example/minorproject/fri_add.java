...
public class fri_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fri_add);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(add_lecture.equals("") || add_class.equals("") || add_subject.equals("") || add_time.equals("") || add_room.equals("")){
                    Toast.makeText(fri_add.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
                else {
                    boolean check = db.insertDataInMonday(add_lecture, add_class, add_subject, add_time, add_room);
                    if(check == true){
                        Toast.makeText(fri_add.this, "added Successfully", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(fri_add.this, "failure!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
